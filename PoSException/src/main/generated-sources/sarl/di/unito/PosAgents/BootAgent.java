...
import di.unito.PosAgents.Parser;
import di.unito.PosAgents.UserAgent;
...
public class BootAgent extends Agent {
  private void $behaviorUnit$Initialize$0(final Initialize occurrence) {
    ...
    _$CAPACITY_USE$IO_SARL_CORE_LIFECYCLE$CALLER.spawn(UserAgent.class, spaceId);
    Lifecycle _$CAPACITY_USE$IO_SARL_CORE_LIFECYCLE$CALLER_1 = this.$CAPACITY_USE$IO_SARL_CORE_LIFECYCLE$CALLER();
    _$CAPACITY_USE$IO_SARL_CORE_LIFECYCLE$CALLER_1.spawn(Parser.class, spaceId);
