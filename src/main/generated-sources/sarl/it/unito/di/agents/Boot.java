...
import it.unito.di.agents.Alice;
import it.unito.di.agents.Bob;
...
public class Boot extends Agent {
  private void $behaviorUnit$Initialize$0(final Initialize occurrence) {
    ...
    _$CAPACITY_USE$IO_SARL_CORE_LIFECYCLE$CALLER.spawn(Alice.class, spaceId);
    Lifecycle _$CAPACITY_USE$IO_SARL_CORE_LIFECYCLE$CALLER_1 = this.$CAPACITY_USE$IO_SARL_CORE_LIFECYCLE$CALLER();
    _$CAPACITY_USE$IO_SARL_CORE_LIFECYCLE$CALLER_1.spawn(Bob.class, spaceId);
